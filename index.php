                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                    ...
                                    if($heure_systeme > "18:00"){echo "Bonsoir";}else{echo "Bonjour";}
                                        ?>
                                     <strong><?php echo $donnee_user['prenom']; ?> <?php echo $donnee_user['nom']; ?></strong><br><small>Dernière connexion: <?php echo $donnee_user['last_connect']; ?></small><br><small>Groupe: CRIDIP SAS</small></h1>
                                </div>
                                <!-- END Main Title -->
