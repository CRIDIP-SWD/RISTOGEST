                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    switch ($donnee_commande['etat_commande']) {
                                                        ...
                                                        case '2':
                                                            echo "<span class='label label-warning'><i class='fa fa-refresh fa-spin'></i> Envoyer chez le prestataire</span>";
                                                            break;

                                                        case '3':
                                                            echo "<span class='label label-info'><i class='fa fa-check'></i> Arrivé à destination</span>";
                                                            break;
                                                ...
                                                <td>
                                                    <a href="<?php echo SITE,FOLDER; ?>module/admin/commande/presta/view.php?idcommande=<?php echo $donnee_commande['idcomprestataire']; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                                </td>
                                            </tr>
                                            <?php } ?>                                           
                                        </tbody>
