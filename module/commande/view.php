                    ...
                    <div class="row">
                    	<div class="col-sm-2">
                    		<div class="block">
                                ...
                                <div class="text-center text-success" style="vertical-align: middle; font-size: 18px; padding-top: 10px; padding-bottom: 10px;"><?php echo $donnee_commande['date_commande']; ?></div>
                            </div>
                    	</div>
                        ...
                        <div class="col-sm-2">
                            <div class="block">
                                ...
                                <div class="text-center text-warning" style="vertical-align: middle; font-size: 18px; padding-top: 10px; padding-bottom: 10px;"><i class="fa fa-spinner fa-spin text-warning"></i></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="block">
                                ...
                                <div class="text-center text-muted" style="vertical-align: middle; font-size: 18px; padding-top: 10px; padding-bottom: 10px;"><i class="fa fa-ellipsis-h text-muted"></i></div>
                            </div>
                        </div>
