                                    ...
                                    <table id="table-menu" class="table table-vcenter table-condensed table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="<?php echo SITE,FOLDER; ?>inc/control/commande.php?etape=step1&idmenu=<?php echo $donnee_menu['idmenu']; ?>&idsalarie=<?php echo $idsalarie; ?>">Passer commande <i class="gi gi-circle_arrow_right"></i></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
